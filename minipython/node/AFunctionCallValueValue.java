...
public final class AFunctionCallValueValue extends PValue
{
    private TId _id_;
    private PFunctionCall _functionCall_;

    public AFunctionCallValueValue()
    {
    }
    ...
    public Object clone()
    {
        return new AFunctionCallValueValue(
            (TId) cloneNode(_id_),
    ...
    {
        ((Analysis) sw).caseAFunctionCallValueValue(this);
    }
